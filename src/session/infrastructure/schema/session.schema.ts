...
import { AgentName, ISession, SessionStatus, SessionType } from '../../domain/session.interface';
...
class Session implements ISession {
  ...
  @Prop({ required: true, enum: SessionStatus, type: String, default: SessionStatus.PENDING })
